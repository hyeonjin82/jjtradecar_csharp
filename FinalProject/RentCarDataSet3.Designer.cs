...
namespace FinalProject {
    ...
    public partial class RentCarDataSet3 : global::System.Data.DataSet {
        ...
        public partial class CarDataTable : global::System.Data.TypedTableBase<CarRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CarRow AddCarRow(string vin, string make, string model, int odometer, string type, string year) {
        ...
        public partial class CarRow : global::System.Data.DataRow {
            ...
            public int odometer {
                get {
                    return ((int)(this[this.tableCar.odometerColumn]));
                }
                set {
...
namespace FinalProject.RentCarDataSet3TableAdapters {
    ...
    public partial class CarTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Car] WHERE (([vin] = @Original_vin) AND ([make] = @Original_ma" +
                "ke) AND ([model] = @Original_model) AND ([odometer] = @Original_odometer) AND ([" +
                "type] = @Original_type) AND ([year] = @Original_year))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Car] ([vin], [make], [model], [odometer], [type], [year]) VALU" +
                "ES (@vin, @make, @model, @odometer, @type, @year);\r\nSELECT vin, make, model, odo" +
                "meter, type, year FROM Car WHERE (vin = @vin)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Car] SET [vin] = @vin, [make] = @make, [model] = @model, [odometer] = @odometer, [type] = @type, [year] = @year WHERE (([vin] = @Original_vin) AND ([make] = @Original_make) AND ([model] = @Original_model) AND ([odometer] = @Original_odometer) AND ([type] = @Original_type) AND ([year] = @Original_year));
SELECT vin, make, model, odometer, type, year FROM Car WHERE (vin = @vin)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT vin, make, model, odometer, type, year FROM dbo.Car";
        ...
        public virtual int Fill(RentCarDataSet3.CarDataTable dataTable) {
        ...
        public virtual RentCarDataSet3.CarDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RentCarDataSet3.CarDataTable dataTable = new RentCarDataSet3.CarDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RentCarDataSet3.CarDataTable dataTable) {
        ...
        public virtual int Delete(string Original_vin, string Original_make, string Original_model, int Original_odometer, string Original_type, string Original_year) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_odometer));
        ...
        public virtual int Insert(string vin, string make, string model, int odometer, string type, string year) {
            if ((vin == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(odometer));
            if ((type == null)) {
        ...
        public virtual int Update(string vin, string make, string model, int odometer, string type, string year, string Original_vin, string Original_make, string Original_model, int Original_odometer, string Original_type, string Original_year) {
            if ((vin == null)) {
                throw new global::System.ArgumentNullException("vin");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(odometer));
            if ((type == null)) {
                throw new global::System.ArgumentNullException("type");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_odometer));
            if ((Original_type == null)) {
                throw new global::System.ArgumentNullException("Original_type");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string make, string model, int odometer, string type, string year, string Original_vin, string Original_make, string Original_model, int Original_odometer, string Original_type, string Original_year) {
            return this.Update(Original_vin, make, model, odometer, type, year, Original_vin, Original_make, Original_model, Original_odometer, Original_type, Original_year);
        }
    }
